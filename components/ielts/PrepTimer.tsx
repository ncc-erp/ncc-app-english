...
export const PrepTimer: React.FC<PrepTimerProps> = ({ durationSeconds = 60, onTimerComplete }) => {
				...
				<div className='flex items-center gap-4'>
					<div className='relative w-16 h-16 flex items-center justify-center'>
						<svg className='w-16 h-16 transform -rotate-90'>
							<circle cx='32' cy='32' r='28' stroke='currentColor' strokeWidth='4' className='text-amber-100' fill='transparent' />
							<circle
								cx='32'
								cy='32'
								r='28'
					...
					<div>
						<div className='text-xs uppercase tracking-wider font-bold text-amber-700'>{t('ielts.prepTimer.label')}</div>
