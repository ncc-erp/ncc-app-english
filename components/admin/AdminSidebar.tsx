...
import { School, FileText, BookOpen, Award, Video, Clock } from 'lucide-react';
...
const SIDEBAR_ITEMS: SidebarItem[] = [
	{ labelKey: 'adminSidebar.classManagement', href: '/admin', icon: School },
	{ labelKey: 'adminSidebar.homeworkManagement', href: '/admin/homework', icon: FileText, disabled: true },
	{ labelKey: 'adminSidebar.mockTestManagement', href: '/admin/topics', icon: BookOpen },
	{ labelKey: 'adminSidebar.batchScoring', href: '/admin/scoring', icon: Award },
	{ labelKey: 'adminSidebar.meetingManagement', href: '/admin/meetings', icon: Video }
];
					...
					{SIDEBAR_ITEMS.map((item) => {
						...
						if (item.disabled) {
							return (
								<div
									key={item.href}
									title={t('adminSidebar.comingSoon')}
