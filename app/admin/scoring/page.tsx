...
export default function AdminScoringPage() {
	...
	// Auth gate — mirrors app/admin/topics/page.tsx
	useEffect(() => {
		...
		return (
			<div className='min-h-screen bg-slate-50 text-slate-900 flex items-center justify-center'>
				<div className='flex items-center space-x-3'>
					...
					<span className='text-sm font-medium text-slate-600'>Verifying admin authorization...</span>
				</div>
			</div>
		);
	}
				...
				<main className='flex-1 flex items-center justify-center p-4'>
					<div className='bg-white border border-slate-200 rounded-3xl p-8 max-w-md w-full text-center space-y-4 shadow-xl'>
						...
						<p className='text-xs text-slate-600 leading-relaxed'>
							You must have the <strong>Admin</strong> role to run batch scoring.
						</p>
						<button
