...
export default function AdminClassesPage() {
	...
	const classFilteredStudents = selectedClassId === 'all' ? allStudents : allStudents.filter((s) => s.class_ids?.includes(selectedClassId));
								...
								>
									...
									<span
										className={`px-2 py-0.5 rounded-full text-[10px] font-extrabold ${
											selectedClassId === 'all' ? 'bg-purple-800/80 text-white' : 'bg-slate-200 text-slate-700'
										}`}
									>
								...
								<div>
									<div className='flex items-center gap-2'>
										<span className='font-extrabold text-slate-900 text-xs'>
											{selectedClassId === 'all' ? 'All Classrooms ' : currentClass?.name || 'Classroom'}
										</span>
							...
							<div className='flex items-center justify-between border-b border-slate-100 pb-4'>
								<div>
									<h3 className='text-base font-extrabold text-slate-900 flex items-center gap-2'>
										...
										<span>{selectedClassId === 'all' ? 'All Students (Role: Student)' : `Students: ${currentClass?.name || 'Classroom'}`}</span>
									</h3>
										...
										>
											...
											<div className='flex items-center space-x-3.5'>
												...
												<div className='space-y-0.5'>
													<div className='flex items-center gap-2'>
														<span className='text-sm font-bold text-slate-900 group-hover:text-purple-700 transition-colors'>{s.display_name}</span>
											...
											<div className='flex items-center justify-between sm:justify-end gap-3 sm:gap-4 shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-200/60'>
												...
												<div className='text-left sm:text-right'>
													...
													<div className='text-xs font-black text-slate-900 flex items-center gap-1'>
														...
														<span>
															{s.total_speaking_attempts} {s.total_speaking_attempts === 1 ? 'test' : 'tests'}
														</span>
													</div>
												</div>
												...
												<div className='text-left sm:text-right'>
													...
													<div
														...
														title={s.latest_attempt_at ? new Date(s.latest_attempt_at).toLocaleString() : undefined}
													>
												...
												<div className='text-left sm:text-right'>
													...
													>
														{s.average_speaking_band ? `Band ${s.average_speaking_band}` : 'N/A'}
													</div>
												</div>
