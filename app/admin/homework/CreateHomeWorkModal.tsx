...
import { BookOpen, Check, Headphones, LayoutDashboard, Mic2, PenLine, Plus, X } from 'lucide-react';
...
export default function CreateHomeworkButton() {
	...
	return (
		<>
			...
			{isOpen && <HomeworkGeneralModal onClose={() => setIsOpen(false)} />}
		</>
	);
}
