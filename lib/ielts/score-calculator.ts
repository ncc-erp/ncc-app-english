...
export function calculateIELTSScore(attempt: IELTSSpeakingAttempt, topic: IELTSSpeakingTopic): IELTSScoreResult {
		...
		criteria_scores: [
			{
				...
				key_observations: [
					...
					fillerResults.length > 0
						? `Identified ${fillerResults.reduce((a, b) => a + b.count, 0)} filler word occurrences.`
						: 'Very low usage of hesitation sounds.'
				]
			},
			{
				code: 'LR',
