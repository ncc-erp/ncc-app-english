export const examEn = {
  ...
  clanJoinCTA: {
    ...
    description: 'Connect with 5,000+ English learners, access weekly quizzes, practice speaking in channels, and immediately unlock your full exam breakdown!',
...
export const examVi = {
  ...
  clanJoinCTA: {
    ...
    description: 'Kết nối với hơn 5.000 người học tiếng Anh, tham gia các bài quiz hàng tuần, luyện nói trong các kênh và mở khóa ngay báo cáo chi tiết bài thi của bạn!',
